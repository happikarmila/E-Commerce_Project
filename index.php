    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up">Find your<br>KarMotix</h2>
          <p data-aos="fade-up" data-aos-delay="100"> Kini saatnya untuk menemukan kekuatan dan kecepatan yang sesuai dengan gaya hidup modern Anda. Dapatkan pengalaman berkendara yang memuaskan dengan motor terbaik dari kami</p>
        </div>
  ...
  <section id="menu" class="menu">
    <div class="container" data-aos="fade-up">
      ...
      <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="tab-pane fade" id="motor-listrik">
